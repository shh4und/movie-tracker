...
func InitSQLite() (*gorm.DB, error) {
	...
	err = db.AutoMigrate(&schemas.Title{}, &schemas.Rating{}, &schemas.User{}, &schemas.UserFavorite{}, &schemas.UserRating{}, &schemas.WatchLater{}, &schemas.WatchedMovie{}, &schemas.UserProfile{}, &schemas.Comment{})
	if err != nil {
